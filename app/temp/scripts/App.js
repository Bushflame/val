...
var stickynav = new _sticky2.default();
new _revealOnScroll2.default((0, _jquery2.default)('.scrollReveal'), '80%');
...
var NavBar = function () {
  function NavBar() {
    ...
    this.navwrap = (0, _jquery2.default)(".navWrap");
    this.menuIcon = (0, _jquery2.default)(".navWrap__menuIcon");
    this.menuContent = (0, _jquery2.default)(".mainNav");
    this.events();
  }
...
var StickyNav = function () {
	function StickyNav() {
		...
		this.navwrap = (0, _jquery2.default)('.navWrap');
		this.navTriggerElement = (0, _jquery2.default)('.top__header-title');
		this.createNavBarWaypoint();
		this.pageSections = (0, _jquery2.default)('.section');
		this.headerLinks = (0, _jquery2.default)('.mainNav a');
	...
	_createClass(StickyNav, [{
		...
		key: 'createNavBarWaypoint',
		value: function createNavBarWaypoint() {
			var that = this;
			new Waypoint({
